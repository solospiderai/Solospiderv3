    ...
    <div className="space-y-8 text-slate-900">
          ...
          <div className="flex items-center gap-3">
            {gscConnected ? (
              ...
              <Link
                ...
                className="flex items-center gap-2 px-3 py-1.5 bg-amber-50 text-amber-800 border border-amber-200 hover:bg-amber-100 rounded-xl text-xs font-semibold transition"
              >
      ...
      {crawledData && (
        <div className="p-5 bg-white border border-slate-200 rounded-2xl space-y-3 shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
            <div>
              <span className="text-slate-500 font-medium">Extracted Industry:</span>
              <div className="text-slate-900 font-semibold mt-0.5">{crawledData.industry}</div>
            </div>
            <div>
              <span className="text-slate-500 font-medium">Crawled Page Assets:</span>
              <div className="flex flex-wrap gap-1 mt-1">
                {crawledData.pages?.map((p) => (
                  <span key={p} className="px-2 py-0.5 bg-slate-100 text-slate-700 rounded-md text-[10px] border border-slate-200">
                    {p}
                  </span>
                ))}
              </div>
            ...
            <div>
              <span className="text-slate-500 font-medium">Extracted Target Keywords:</span>
              <div className="flex flex-wrap gap-1 mt-1">
                {crawledData.keywords?.map((k) => (
                  <span key={k} className="px-2 py-0.5 bg-blue-50 text-blue-700 border border-blue-100 rounded-md text-[10px]">
                    {k}
                  </span>
                ))}
              </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="bg-white border border-slate-200 p-5 rounded-xl shadow-sm">
          ...
          <div className="text-[11px] text-slate-500 mt-1">
            Open Rate: <span className="text-slate-900 font-semibold">42.5%</span>
          </div>
        </div>
        ...
        <div className="bg-white border border-slate-200 p-5 rounded-xl shadow-sm">
          ...
          <div className="text-[11px] text-slate-500 mt-1">
            Avg Authority: <span className="text-slate-900 font-semibold">58 DR</span> (Est.)
          </div>
        </div>
          ...
          <div className="p-4 bg-slate-50 border border-slate-200 rounded-xl flex items-center justify-between">
            <div className="space-y-1">
              <div className="font-bold text-slate-900 flex items-center gap-2">
                ...
                <span className="px-2 py-0.5 bg-slate-200 text-slate-700 rounded-md text-[10px]">SaaS Directory</span>
              </div>
            ...
            <div className="text-right space-y-1">
              <div className="text-emerald-600 font-bold text-base">94 Score</div>
              <Link
          ...
          <div className="p-4 bg-slate-50 border border-slate-200 rounded-xl flex items-center justify-between">
            <div className="space-y-1">
              <div className="font-bold text-slate-900 flex items-center gap-2">
                ...
                <span className="px-2 py-0.5 bg-slate-200 text-slate-700 rounded-md text-[10px]">Blog</span>
              </div>
              <p className="text-slate-600 max-w-xl text-[11px]">
            ...
            <div className="text-right space-y-1">
              <div className="text-emerald-600 font-bold text-base">88 Score</div>
              <Link
                href="/app/en/backlinks/campaigns"
                className="inline-block px-3 py-1 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-[11px] font-medium transition"
              >
